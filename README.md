...
- Reuse saved SHAP caches when they exist, with dynamic Kernel SHAP fallback
...
- Set `CFDNA_USE_SAVED_SHAP=0` only if you want to force dynamic Kernel SHAP instead of cached explanations.
