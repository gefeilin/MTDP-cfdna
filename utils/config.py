...
SHAP_EXPLAINER_DIR = APP_DATA_DIR / "saved_explainers"

CAT_EMBEDDING_DIM = 4
EMBEDDING_MIN_CLASSES = 3
MC_SAMPLES_DEFAULT = 1000
MC_INTERVAL_ALPHA = 0.10
MC_RANDOM_SEED_DEFAULT = 506
SHAP_BACKGROUND_SIZE = 32
SHAP_NSAMPLES = 128
SHAP_L1_REG = "num_features(12)"
USE_SAVED_SHAP_DEFAULT = True
USE_SAVED_EXPLAINER_DEFAULT = True
